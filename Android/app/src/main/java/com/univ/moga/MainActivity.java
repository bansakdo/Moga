...
import static com.univ.moga.Component.default_url;
...
import static com.univ.moga.DataIOKt.getUnread;

public class MainActivity extends AppCompatActivity {
    private static final String TAG = "MainActivity";
    // TEST GIT
    private FragmentManager fm = getSupportFragmentManager();
    private com.univ.moga.moga.TimeTableFragment f_TimeTable2 = new com.univ.moga.moga.TimeTableFragment();
    ...
    private void switchFragment(int itemId) {
        ...
        switch (itemId) {
            case R.id.bottomNavigationTimeTable: {
                ...
                if(!(fragment instanceof com.univ.moga.moga.TimeTableFragment)) {
